...
import { BookOpen, FileText, GraduationCap, LogOut, Rocket } from "lucide-react";
    ...
    <Sidebar className="border-r shadow-sm">
      <SidebarHeader className="w-full flex flex-col items-start px-5 py-6 border-b relative">
        <div className="flex items-center gap-3 w-full">
          ...
          <div className="flex flex-col">
            <span className="font-bold tracking-tight text-lg leading-tight">MCA Notes</span>
            <span className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wider">Admin Dashboard</span>
          </div>
        </div>
      ...
      <SidebarContent className="px-3 pt-6 pb-4">
        ...
        <div className="px-2 mb-6">
          <Link href="/admin/seed/seed-questions" className="block w-full outline-none">
            <Button 
              className={cn(
            ...
            >
              ...
              <span className="font-bold text-base tracking-wide">Seed Content</span>
            </Button>
          </Link>
        </div>
        ...
        <div className="bg-muted/30 p-4 rounded-xl border border-muted/50 flex flex-col gap-3 shadow-sm">
          <div className="flex items-center gap-3 mb-1">
            ...
            <div className="flex flex-col overflow-hidden">
              <span className="text-sm font-semibold leading-tight truncate">Admin User</span>
              <span className="text-[10px] text-muted-foreground truncate">Manage content</span>
            </div>
          </div>
          <SignOutButton>
            <Button
